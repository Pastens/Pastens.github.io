...
> 本文基于知识库中 **~60 篇**性能建模仿真相关的芯片建模、训练系统、推理系统、缓存系统和开源项目分析笔记编写而成，旨在为新接触本领域的同事提供从理论基础到前沿方法论的系统性入门指南。
...
6. **理解 ML 方法**：阅读 NeuSight 和 Ithemal
7. **理解调度建模**：阅读 Pollux 和 Gavel
...
9. **搭建自己的小型仿真**：选择一个模型（如 LLaMA-7B），profile 几个算子，构建简单的延迟预测模型
...
- [[Knowledge/论文分析/训练系统/Universal Performance Model 技术分析]]
- [[Knowledge/论文分析/训练系统/Chakra 技术分析]]
- [[Knowledge/论文分析/训练系统/Pollux 技术分析]]
