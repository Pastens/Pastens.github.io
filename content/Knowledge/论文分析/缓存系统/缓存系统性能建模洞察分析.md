...
## 相关链接
- [[Knowledge/论文分析/推理系统/LLM推理系统深度综述]] — KV Cache 是 LLM 推理建模的核心
- [[Knowledge/论文分析/推荐系统/推荐系统性能建模综述]] — Embedding 表的性能建模
- [[Knowledge/论文分析/推荐系统/DLRM 训练性能模型分析]] — 唯一的 Embedding 性能模型
- [[Knowledge/论文分析/芯片建模/芯片性能建模与仿真深度综述]] — 底层存储层级的硬件建模
