...
|---|------|-------|------|---------|---------|
| 1 | **DLRM** (Facebook) | 1906.00091 | 2019 | 推荐的深度模型架构标准，特征交互+MLP | [[推荐系统/DLRM 技术分析]] |
| 2 | **Performance Benchmarking** | 2406.17335 | 2024 | 轻量化 Embedding RecSys 的全面性能基准 | [[推荐系统/RecSys 性能基准分析]] |

### 3.2 训练系统性能建模

| # | 论文 | arXiv | 年份 | 核心贡献 | 分析笔记 |
|---|------|-------|------|---------|---------|
| 3 | **Performance Model for DLRM** | 2201.07821 | 2022 | GPU DLRM 训练的解析式性能模型（首个） | [[推荐系统/DLRM 训练性能模型分析]] |
| 4 | **2D Sparse Parallelism** | 2508.03854 | 2025 | 二维稀疏并行，优化 Emb+MLP 混合训练 | [[推荐系统/2D 稀疏并行分析]] |
| 5 | **Merlin HugeCTR** | 2210.08803 | 2022 | NVIDIA GPU 加速 RecSys 训练推理框架 | [[推荐系统/Merlin HugeCTR 分析]] |

### 3.3 推理服务优化

| # | 论文 | 发表 | 年份 | 核心贡献 | 分析笔记 |
|---|------|------|------|---------|---------|
| 6 | **MicroRec** | 2010.05894 | 2020 | RecSys 推理硬件+数据结构联合优化，ETH | [[推荐系统/MicroRec 分析]] |
| 7 | **TorchRec** | Meta开源 | 2022 | PyTorch RecSys 训练推理库，Embedding sharding 集成 | [[推荐系统/TorchRec 分析]] |
